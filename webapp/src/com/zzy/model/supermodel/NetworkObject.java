...
abstract public class NetworkObject extends ModelObject<Long> {
	...
	public Integer getSearchUniqueness() {
		return searchUniqueness;
	}
	
	public void setSearchUniqueness(Integer searchUniqueness) {
		this.searchUniqueness = searchUniqueness;
	}
	
	public abstract Integer getSearchUniquenessValues();
	/**
	 *
	 *
	 * getNetwork
